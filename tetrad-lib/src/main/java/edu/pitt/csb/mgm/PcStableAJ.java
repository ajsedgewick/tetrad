 ...
 */
public class PcStableAJ implements GraphSearch {

    /**
     * The independence test used for the PC search.
     */
    private IndTestMixedMultipleTTest independenceTest;
     ...
     */
    public PcStableAJ(IndTestMixedMultipleTTest independenceTest) {
     ...
     */
    public IndTestMixedMultipleTTest getIndependenceTest() {
...
//        IFas fas = new FasStable2b(getIndependenceTest());
        IFas fas = new FasStableConcurrentAJ(getIndependenceTest());
